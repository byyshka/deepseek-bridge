...
const ASK_DESCRIPTION = [
  ...
  "",
  "IT IS NOT A READER. DSH has its own write and shell tools, governed by ITS permission settings,",
  "not by this bridge; `cwd` decides what it can reach; and the child process inherits this server's",
  "whole environment, credentials included. Phrase tasks so that writing is not implied, and do not",
  "point `cwd` somewhere you would not let an agent loose.",
  "",
  ...
  "codebase are evidence only insofar as it actually read the files — and the reply cannot show",
  "which tools it used, so a factual claim needs checking against the file yourself.",
  "",
